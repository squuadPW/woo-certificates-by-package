...
<form method="post" action="<?php echo esc_url($endpoint_url); ?>">
    ...
    <div class="form-row">
        <p class="form-row-field">
            ...
            <input type="number" id="academic_hours" name="academic_hours" value="<?php echo esc_attr($academic_hours); ?>" required>
        </p>
    ...
    <div class="form-row">
        ...
        <p class="form-row-field">
            ...
            <input type="date" id="course_date" class="input-text input-field" name="course_date" value="<?php echo esc_attr($course_date); ?>">
        </p>
    </div>
