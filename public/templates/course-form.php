...
<form method="post" action="<?php echo esc_url($endpoint_url); ?>" id="course-form">
    ...
    <div class="form-row">
        <p class="form-row-field">
            ...
            <input class="formdata" type="text" id="course_name" name="course_name" value="<?php echo esc_attr($course_name); ?>" maxlength="300">
    ...
    <div class="form-row">
        <p class="form-row-field">
            ...
            <input class="formdata" type="text" id="tutor_instructor" name="tutor_instructor" value="<?php echo esc_attr($tutor_instructor); ?>">
        </p>
        <p class="form-row-field">
            ...
            <input class="formdata border-input-radius" type="number" step="0.01" id="academic_hours" name="academic_hours" value="<?php echo esc_attr($academic_hours); ?>" min="0">
            <span class="validation-message"></span>
        </p>
    </div>
    ...
    <div class="form-row">
        <p class="form-row-field">
            ...
            <input class="formdata" type="text" id="location" name="location" value="<?php echo esc_attr($location); ?>">
        </p>
        <p class="form-row-field">
            <label for="course_date"><?php echo __('Date', 'woocertificatespackage'); ?></label>
            <input type="date" id="course_date" class="formdata" name="course_date" value="<?php echo esc_attr($course_date); ?>" min="<?php echo date('Y-m-d'); ?>">
            <span class="validation-message"></span>
        </p>
    </div>
    ...
    <div class="form-row">
        <p class="form-row-field">
            ...
            <textarea class="formdata" id="academic_program" name="academic_program"><?php echo esc_textarea($academic_program); ?></textarea>
            <span class="validation-message"></span>
        </p>
    </div>
    ...
    <div class="form-row form-row--three-fields">
        <p class="form-row-field">
            ...
            <input class="formdata border-input-radius" type="number" step="0.01" id="price_per_student" name="price_per_student" value="<?php echo esc_attr($price_per_student); ?>" min="0">
            <span class="validation-message"></span>
        </p>
        <p class="form-row-field">
        ...
        <p class="form-row-field">
            ...
            <input class="formdata border-input-radius" type="number" step="0.01" id="certification_fee_value" name="certification_fee_value" value="<?php echo esc_attr($certification_fee_value); ?>" min="0">
            <span class="validation-message"></span>
        </p>
    </div>
    <p class="p-legends">
