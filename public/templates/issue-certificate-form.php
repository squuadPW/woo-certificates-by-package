            ...
            <form method="post" action="" id="issue-single-student-form">
                ...
                <div class="form-row form-row--three-fields">
                    <p class="form-row-field">
                        ...
                        <select class="input-text" name="single_student_document_type" id="single_student_document_type" required>
                    ...
                    <p id="nationality-container" style="display: none;" class="form-row-field">
                        ...
                        <select class="input-text" name="single_student_inssued_in" id="single_student_inssued_in" required>
